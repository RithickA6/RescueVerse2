...
export default function GameEngine({ scenario, onSimulationEnd }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <div>
            ...
            <span
              className={`rv-badge rv-badge-${difficulty === "advanced" ? "red" : difficulty === "intermediate" ? "amber" : "green"}`}
      ...
      {/* Health bar */}
      <div
        style={{ height: 4, background: "var(--border)", position: "relative" }}
      >
        <div
          style={{
            height: "100%",
      ...
      <div
        ref={mountRef}
        style={{ width: 800, height: 560, display: "block" }}
      />
      ...
      >
        WASD / Arrows: Move &nbsp;·&nbsp; SPACE: Take Cover &nbsp;·&nbsp; E:
        Help NPC
      </div>
